                                        ...
                                        <>
                                            {task.attachment.match(/\.(jpeg|jpg|gif|png|webp)$/i) ? (
                                                <div style={{ marginBottom: 16, borderRadius: 16, overflow: "hidden", border: "1px solid #e2e8f0", display: "inline-block" }}>
                                                    <img src={`${import.meta.env.VITE_API_BASE_URL}/storage/${task.attachment}`} alt="Lampiran Dosen" style={{ maxWidth: "100%", maxHeight: 300, display: "block" }} />
                                                </div>
                                            ) : null}
                                            <a href={`${import.meta.env.VITE_API_BASE_URL}/storage/${task.attachment}`} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 10, padding: "12px 20px", background: "#f8fafc", borderRadius: 12, border: "1px solid #e2e8f0", color: "#4f46e5", fontSize: 14, fontWeight: 800, textDecoration: "none", transition: "all 0.2s", width: "fit-content" }} onMouseEnter={e => { e.currentTarget.style.background = "white"; e.currentTarget.style.borderColor = "#c7d2fe"; e.currentTarget.style.boxShadow = "0 4px 12px rgba(0,0,0,0.05)"; }} onMouseLeave={e => { e.currentTarget.style.background = "#f8fafc"; e.currentTarget.style.borderColor = "#e2e8f0"; e.currentTarget.style.boxShadow = "none"; }}>
                                                <Download size={18} />
