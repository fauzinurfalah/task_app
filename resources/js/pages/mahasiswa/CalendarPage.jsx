...
const TYPE_CONFIG = {
    exam:       { bg: "#fef2f2", color: "#dc2626", label: "UJIAN" },
    assignment: { bg: "#f5f3ff", color: "#8b5cf6", label: "TUGAS" },
            ...
            <div className="app-wrapper">
                ...
                <main className="main-content" style={{ background: "#f8fafc", padding: "40px 48px", minHeight: "100vh" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
                        <div>
                            <h1 style={{ fontSize: 32, fontWeight: 900, color: "#0f172a", margin: "0 0 8px", letterSpacing: "-0.5px", display: "flex", alignItems: "center", gap: 12 }}>
                                <CalendarIcon size={32} color="#8b5cf6" /> Kalender Akademik
                            </h1>
                            <p style={{ fontSize: 15, color: "#64748b", margin: 0, fontWeight: 600 }}>Pantau tenggat waktu tugas dan jadwal Anda bulan ini.</p>
                        </div>
                    </div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 380px", gap: 32, alignItems: "start" }}>
                        ...
                        <div style={{ background: "white", borderRadius: 32, padding: "32px", border: "1px solid #e2e8f0", boxShadow: "0 4px 24px rgba(0,0,0,0.02)" }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 12 }}>
                                {cells.map((cell, idx) => {
                                    ...
                                    return (
                                        <div key={idx} style={{ minHeight: 110, borderRadius: 20, background: isToday ? "#8b5cf6" : cell.currentMonth ? (isWeekend ? "#fafafa" : "white") : "#f8fafc", border: isToday ? "none" : cell.currentMonth ? "1px solid #e2e8f0" : "1px dashed #cbd5e1", padding: "12px", position: "relative", opacity: cell.currentMonth ? 1 : 0.5, boxShadow: isToday ? "0 8px 24px rgba(139,92,246,.3)" : "none", transition: "transform 0.2s", cursor: "default" }} onMouseEnter={e => cell.currentMonth && (e.currentTarget.style.transform = "translateY(-2px)")} onMouseLeave={e => cell.currentMonth && (e.currentTarget.style.transform = "translateY(0)")}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                            ...
                            <div style={{ background: "white", borderRadius: 32, padding: "32px", border: "1px solid #e2e8f0", boxShadow: "0 4px 24px rgba(0,0,0,0.02)" }}>
                                ...
                                <button onClick={() => navigate('/mahasiswa/tasks')} style={{ width: "100%", padding: "16px", borderRadius: 16, border: "1.5px solid #e2e8f0", background: "white", color: "#0f172a", fontSize: 14, fontWeight: 800, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginTop: 16, transition: "all 0.2s" }} onMouseEnter={e => { e.currentTarget.style.background = "#f8fafc"; e.currentTarget.style.borderColor = "#cbd5e1"; }} onMouseLeave={e => { e.currentTarget.style.background = "white"; e.currentTarget.style.borderColor = "#e2e8f0"; }}>
