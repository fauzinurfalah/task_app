...
import { User, Mail, Hash, Edit3, Save, X, LogOut, BookOpen } from "lucide-react";
            ...
            <div onClick={e => e.stopPropagation()} style={{ background: "white", borderRadius: 32, width: "100%", maxWidth: 440, padding: 32, boxShadow: "0 24px 64px rgba(0,0,0,.2)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                    ...
                    <div>
                        ...
                        <input value={form.nim} onChange={s("nim")} style={inp} onFocus={focus} onBlur={blur} />
                    </div>
                </div>
                <div style={{ display: "flex", gap: 12, marginTop: 32 }}>
                    ...
                    <button onClick={() => { onSave(form); onClose(); }}
                        style={{ flex: 2, padding: "14px", borderRadius: 16, background: "linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%)", color: "white", border: "none", fontSize: 14, fontWeight: 800, cursor: "pointer", boxShadow: "0 8px 20px rgba(139,92,246,.25)", transition: "all 0.2s", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }} onMouseEnter={e => e.currentTarget.style.transform = "translateY(-2px)"} onMouseLeave={e => e.currentTarget.style.transform = "translateY(0)"}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 12, textAlign: "left", marginBottom: 40 }}>
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 16, padding: "16px 20px", background: "#f8fafc", borderRadius: 20, border: "1px solid #f1f5f9" }}>
                                ...
                                <div>
                                    ...
                                    <p style={{ fontSize: 14, fontWeight: 700, color: "#0f172a", margin: 0 }}>{profile.nim}</p>
                                </div>
                            </div>
                        </div>
